 ...
 */
#include "interface_scan_module.hpp"

GenericInterface::GenericInterface(char _domain[256], char _headers[8192], char _proto_port[128])
{
...
GenericStruct GenericInterface::interface_scan(char path[2048], bool *cancel_flag, int &sock, SSL *&ssl)
{
