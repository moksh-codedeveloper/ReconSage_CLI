...
private:
    char domain[256] = {0};
    double k_factor;
    void calculate_z_score(vector<double> &status_code_z_score, vector<double> &latency_z_score, vector<double> &char_tokens_z_score)
    {
...
public:
    RecoGAN_Module(char _domain[256], double _k_factor)
    {
    ...
    void predict()
    {
        ...
        calculate_z_score(status_code_z_score, latency_z_score, char_tokens_z_score);
