...
void Reco_GAN_Prediction_Module::absolute_filename_domain_sanitization(char absolute_file_name[768], const char *base_dir)
{
...
Reco_GAN_Prediction_Module::Reco_GAN_Prediction_Module(const char _domain[256])
{
...
double Reco_GAN_Prediction_Module::normalize_z_score(double mean, double stddev, double live_vals)
{
    return (live_vals - mean) / stddev;
}

vector<TelemetryTensor> Reco_GAN_Prediction_Module::FileToCompile()
{
...
TelemetryProcessedData Reco_GAN_Prediction_Module::UnpackData(const vector<TelemetryTensor> &dataset)
{
...
vector<double> Reco_GAN_Prediction_Module::status_calc_z_score_feature(RecoGAN_Prediction_Module &status_output, const vector<double> &live_status_code_dataset)
{
...
vector<double> Reco_GAN_Prediction_Module::latency_calc_z_score(RecoGAN_Prediction_Module &latency_output, const vector<double> &live_latency_dataset)
{
...
vector<double> Reco_GAN_Prediction_Module::char_tokens_z_score(Reco_GAN_Tokens_Prediction_Module &char_tokens_mean_stddev_shared_object, const vector<vector<double>> &live_char_tokens_dataset)
{
...
void Reco_GAN_Prediction_Module::extract_mean_stddev_code_latency_data(RecoGAN_Prediction_Module &status_code_shared_obj, RecoGAN_Prediction_Module &latency_shared_obj)
{
...
void Reco_GAN_Prediction_Module::extract_mean_stddev_char_tokens(Reco_GAN_Tokens_Prediction_Module &char_tokens_mean_stddev_shared_object)
{
...
void Reco_GAN_Prediction_Module::extract_thresholds_status_code_latency_data(StatusCodeAndLatML &status_code_shared_object, StatusCodeAndLatML &latency_shared_object)
{
...
void Reco_GAN_Prediction_Module::extract_thresholds_char_tokens_data(TokensML &char_tokens_thresholds_data)
{
    char thresholds_file_name[768] = {0};
    absolute_filename_domain_sanitization(thresholds_file_name, target_dir);
