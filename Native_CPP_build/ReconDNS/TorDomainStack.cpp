 ...
 */
#include "TorDomainStack.hpp"

TorDnsResolver::TorDnsResolver(char _domain[256], int _dns_timeout, char _dns_server[256], char _proxy_host[256], int _proxy_port)
{
...
string TorDnsResolver::resolvede()
{
    string resolved = "";
