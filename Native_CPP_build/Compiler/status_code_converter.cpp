...
uint16_t StatusCodeCompiler::codes_to_hex(int code)
{
...
uint16_t StatusCodeCompiler::adv_codes_to_hex(int code)
{
...
uint16_t StatusCodeCompiler::other_no_codes_match_to_hex(int code)
{
...
vector<uint16_t> StatusCodeCompiler::arr_codes_to_hex()
{
...
StatusCodeCompiler::StatusCodeCompiler(vector<int> _status_code_arr, char _domain[256])
{
...
Compiler_Struct StatusCodeCompiler::Compile()
{
